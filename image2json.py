...
def extract_text_regions(image_path, output_file='ocr_results.json', show_image=False):
  ...
  for contour in contours:
    ...
    cv2.rectangle(image, (x, y), (x + w, y + h), (0, 255, 0), 2)  # Draw rectangle around contour
...
image_shape = extract_text_regions(image_path, show_image=True)
